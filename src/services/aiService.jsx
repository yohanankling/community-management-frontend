...
// Create an Axios instance for AI-related service calls.
...
// Function to send an AI prompt to the backend.
export const sendAiPrompt = async (promptText) => {
    try {
        // Make a POST request to the '/ai/rate_all' endpoint with the manager_prompt.
